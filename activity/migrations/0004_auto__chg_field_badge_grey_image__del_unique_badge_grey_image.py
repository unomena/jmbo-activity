...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Badge', fields ['grey_image']
        db.delete_unique('activity_badge', ['grey_image_id'])


        # Changing field 'Badge.grey_image'
        db.alter_column('activity_badge', 'grey_image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activity.BadgeGreyImage'], null=True))

    def backwards(self, orm):

        # Changing field 'Badge.grey_image'
        db.alter_column('activity_badge', 'grey_image_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['activity.BadgeGreyImage'], unique=True, null=True))
        # Adding unique constraint on 'Badge', fields ['grey_image']
        db.create_unique('activity_badge', ['grey_image_id'])
