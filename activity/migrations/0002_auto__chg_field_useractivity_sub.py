...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserActivity.sub'
        db.alter_column('activity_useractivity', 'sub', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'UserActivity.sub'
        db.alter_column('activity_useractivity', 'sub', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
