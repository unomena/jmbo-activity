...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadgeGreyImage'
        db.create_table('activity_badgegreyimage', (
            ...
            ('effect', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='badgegreyimage_related', null=True, to=orm['photologue.PhotoEffect'])),
        ))
        db.send_create_signal('activity', ['BadgeGreyImage'])

        # Adding field 'Badge.grey_image'
        db.add_column('activity_badge', 'grey_image',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['activity.BadgeGreyImage'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BadgeGreyImage'
        db.delete_table('activity_badgegreyimage')

        # Deleting field 'Badge.grey_image'
        db.delete_column('activity_badge', 'grey_image_id')
    ...
    models = {
        'activity.badge': {
            ...
            'grey_image': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['activity.BadgeGreyImage']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
